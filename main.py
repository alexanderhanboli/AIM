...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='mnist', choices=['mnist', 'fashion-mnist', 'cifar10', 'celebA', 'mixed-Gaussian'],
    ...
    parser.add_argument('--lrG', type=float, default=5e-4)
    parser.add_argument('--lrD', type=float, default=5e-4)
    parser.add_argument('--lrE', type=float, default=5e-4)
